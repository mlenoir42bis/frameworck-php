                    ...
                    <div class="full-width-mega-dropdown">
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12">
                                <div class="logo">
                                    <a href="index.html">
                                        <img src="../../../../webroot/assets/images/logo/logo.png" alt="main logo">
                                    </a>
                                </div>
                            </div>
                            <!-- primary-menu -->
                                        ...
                                        <li class="mega-parent"><a href="shop.html">Products</a>
                                            <div class="mega-menu-area clearfix">
                                                ...
                                                <div class="mega-menu-photo f-left">
                                                    <a href="#">
                                                        <img src="../../../../webroot/assets/images/mega-menu/1.jpg" alt="mega menu image">
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                                    ...
                                                    <div class="total-cart-pro">
                                                        ...
                                                        <div class="single-cart clearfix">
                                                            <div class="cart-img f-left">
                                                                <a href="#">
                                                                    <img src="../../../../webroot/assets/images/cart/1.jpg" alt="Cart Product" />
                                                                </a>
                                                                <div class="del-icon">
                                                                    <a href="#">
