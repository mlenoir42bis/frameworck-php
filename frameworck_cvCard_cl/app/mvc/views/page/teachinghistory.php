      ...
      <div class="row">
        ...
        <?php include_once("includes/sidebarTeaching.php"); ?>
          ...
          <div class="col-sm-10" id="teaching">
            ...
            <div class="block">
              <h2 class="text-center" >Your teaching history</h2>
              <hr>
              <form id="formteachingDesc" method='POST'>
                <div class="form-group">
                  <label for="descriptionDesc">Your Description</label>
                  <textarea class="form-control" name="description" id="descriptionDesc" rows="7"><?php echo $data['descriptionTeaching'][0]['description'] ;?></textarea>
                </div>
            ...
            <div class="col-md-6">
              <h2 class="text-center" >Teaching history</h2>
              <hr>
              <ul id="sortable">
                <?php
                  $i = 0;
    ...
    <script type="text/javascript" src="../../assets/javascripts/back/my/teachingHistory.js"></script>
